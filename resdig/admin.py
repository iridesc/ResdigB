...
@admin.register(Errotable)
class erroAdmin(admin.ModelAdmin):
    list_display=('errotype','errotime','message','sendmail')
...
class AppversionAdmin(admin.ModelAdmin):
    list_display=('updatetime','versioncode','versionname','describe','downloadlink')
...
class DonatetAdmin(admin.ModelAdmin):
    list_display = ('donatetime', 'donator', 'donatetype', 'describe', 'message')
